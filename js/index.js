...
var Model = {
  tasks: [
    ...
    },
    {
      ...
      status: 'doing',
      id: '4321'
    }, //added comma to separate objects in the array
    {
      text: '!!',
      status: 'done',
      id: '9999'
...
var Controller = {
  ...
  handleSubmit: function(event) {
    event.preventDefault(); //fixed syntax on preventDefault function
  ...
  handleLoad: function() {
    $.ajax({
      ...
      success: function(data) {
        data.forEach(function(task) { //Removed .tasks because that doesn't map to anything
          Model.addTask(task.text); //Added .text to grab only the text from Jacob's data structure
        });
        View.renderBoard();
      }
    });
